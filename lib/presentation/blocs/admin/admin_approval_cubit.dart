...
class AdminApprovalCubit extends Cubit<AdminApprovalState> {
  ...
  /// TIDAK memanggil loadRegistrations() di sini — biar state AdminApproveSuccess
  /// punya kesempatan ditangkap BlocListener di halaman (misal untuk pop & snackbar)
  /// sebelum ditimpa state Loading dari reload. Pemanggil (UI) yang reload setelahnya.
  ...
  /// Sama seperti approveOperator, TIDAK auto-reload di sini.
